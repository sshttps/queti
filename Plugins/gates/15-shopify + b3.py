...
@Client.on_message(filters.command("popo", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>POSEIDON</code>
PASARELA: <code>SHOPIFY + B3 $281.56</code> </b>""")
...
<b>あ MITSURI CHK あ</b> 
<b>Gateway: <code>POSEIDON</code></b>
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '19000475156549'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://ind-distribution.com/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://ind-distribution.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.ind-distribution.com"
        }
...
<b>MITSURI CHK - SH + B3 $291.56 USD</b>
