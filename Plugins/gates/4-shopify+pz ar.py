...
@Client.on_message(filters.command("ar", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
GATEWAY: <code>ARES</code>
PASARELA: <code>SHOPIFY + PZ $38.98</code></b>""")
...
<b>MITSURI CHK - SH + PZ 38.98 USD</b>
