...
@Client.on_message(filters.command("ul", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ
ESTADO: <code>ON</code>
GATEWAY: <code>ULISES</code>
PASARELA: <code>SHOPIFY $48.79</code> </b>""")
...
<b>Informacion:</b> {x.get("type")} {x.get("level")} {x.get("flag")}""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '37897175892135'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://novelkeys.com/cart/add.js', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://novelkeys.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.novelkeys.com"
        }
        ...
        payload_5 = f'_method=patch&authenticity_token={authenticity_token}&previous_step=payment_method&step=&s={id_}&checkout%5Bpayment_gateway%5D=5692031016&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Bremember_me%5D=false&checkout%5Bremember_me%5D=0&checkout%5Bvault_phone%5D=%2B17122910111&checkout%5Btotal_price%5D=4879&checkout_submitted_request_url=https%3A%2F%2Fnovelkeys.com%2F30998088%2Fcheckouts%2F9615ab0827b7d5825ff934857656214d%3Fprevious_step%3Dshipping_method%26step%3Dpayment_method&checkout_submitted_page_id=c6adf78f-2A89-4BF0-6D2F-CB34063DDA9C&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=759&checkout%5Bclient_details%5D%5Bbrowser_height%5D=738&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=180'
